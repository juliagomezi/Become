...
public class ControllerActivityDB {
    ...
    public void getActivitiesByDay(String idRoutine, String day, Method method, Object object) {
        db.collection("routines").document(idRoutine).collection("activities").whereEqualTo("day", day).addSnapshotListener((value, e) -> {
            if (e != null) {
    ...
    public String createActivity(String idRoutine, String activityName, String actTheme,String actDescription, String actDay, String beginTime, String finishTime) {
        CollectionReference refToActivities = db.collection("routines").document(idRoutine).collection("activities");
    ...
    public void deleteActivity(String idRoutine, String idActivity) {
        ...
        docRefToActivity = db.collection("routines").document(idRoutine).collection("activities").document(idActivity);
     ...
     */
    public void updateActivity(String idRoutine, String actName, String description, String theme, String day, String iniT, String endT,  String idActivity) {
        DocumentReference docRefToActivity = db.collection("routines").document(idRoutine).collection("activities").document(idActivity);

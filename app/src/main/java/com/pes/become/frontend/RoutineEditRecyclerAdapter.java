...
public class RoutineEditRecyclerAdapter extends RecyclerView.Adapter<RoutineEditRecyclerAdapter.ViewHolder> {
     ...
     */
    public RoutineEditRecyclerAdapter(ArrayList<ArrayList<String>> activitiesList) {
